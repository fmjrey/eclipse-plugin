...
/**
 * RemoveGradleNatureAction is responsible for managing the removal of the Gradle nature from a java based 
 * project.
 */
public class RemoveGradleNatureAction implements IObjectActionDelegate {
    ...
    public void run(final IAction action) {
        ...
        if (currSelected != null && currSelected.size() > 0) {
           for (IProject project : currSelected) {
           	try {
					GradleUtil.removeGradleNature(project);
